...
import { Lead, NurturingStatus } from '../types';
...
const NURTURING_COLUMNS: {
  ...
  { status: NurturingStatus.LANDING, label: 'Landing', color: 'border-t-sky-400', headerBg: 'bg-sky-50', dot: 'bg-sky-400' },
  { status: NurturingStatus.SEGUIMIENTO_1, label: 'Seguimiento 1', color: 'border-t-amber-400', headerBg: 'bg-amber-50', dot: 'bg-amber-400' },
  { status: NurturingStatus.SEGUIMIENTO_2, label: 'Seguimiento 2', color: 'border-t-amber-500', headerBg: 'bg-amber-50', dot: 'bg-amber-500' },
  { status: NurturingStatus.SEGUIMIENTO_3, label: 'Seguimiento 3', color: 'border-t-amber-600', headerBg: 'bg-amber-50', dot: 'bg-amber-600' },
  { status: NurturingStatus.SECUENCIA_EMAIL, label: 'Secuencia Email', color: 'border-t-violet-400', headerBg: 'bg-violet-50', dot: 'bg-violet-400' },
  { status: NurturingStatus.PAUSADO, label: 'Pausado', color: 'border-t-slate-400', headerBg: 'bg-slate-50', dot: 'bg-slate-400' },
  { status: NurturingStatus.DESCARTADO, label: 'Descartado', color: 'border-t-red-400', headerBg: 'bg-red-50', dot: 'bg-red-400' },
];
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="px-4 py-2 border-b border-slate-200 bg-white flex items-center gap-3">
        ...
        <p className="text-xs text-slate-400">Leads en proceso de maduración hacia MQL/SQL</p>
      </div>
