      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-slate-50">
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        ...
                        <tr className="bg-slate-100 border-b border-slate-200">
                            ...
                            {/* Columna: Negociación (Calculada) */}
                            <th className="py-4 px-4 border-l border-slate-200 w-1/5 bg-fuchsia-50/50">
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between items-start">
                                        <span className="text-xs uppercase tracking-wider font-bold text-fuchsia-700">Meta Negoc.</span>
                            ...
                            {/* Columna: Cotización (Calculada) */}
                            <th className="py-4 px-4 border-l border-slate-200 w-1/5 bg-indigo-50/50">
                                <div className="flex flex-col gap-2">
                                    <div className="flex justify-between items-start">
                                        <span className="text-xs uppercase tracking-wider font-bold text-indigo-700">Meta Cotizado</span>
                                    </div>

                                    {/* Multiplier Input inside Header */}
                                    <div className="flex items-center gap-2 bg-white p-1.5 rounded border border-indigo-200 shadow-sm">
                                        <span className="text-[10px] font-bold text-slate-500 whitespace-nowrap">Negoc. x</span>
                                        <input 
                                            type="number" 
                                            step="0.1"
                    ...
                    <tbody className="text-sm">
                        {MONTHS.map((month, index) => {
                            ...
                            const negVal = salesVal * formData.NEG_MULT;
                            const quoVal = negVal * formData.QUO_MULT;
            ...
            <p className="mt-4 text-xs text-slate-400 text-center">
                * Las metas de "Negociación" y "Cotizado" son calculadas. "Ventas Reales" muestra lo facturado en CRM (Estado: Ganados) para el año fiscal seleccionado.
            </p>
